import { pgTable, uuid, varchar, doublePrecision, integer, text, unique, pgSequence } from "drizzle-orm/pg-core"
...
export const users = pgTable("users", {
	id: integer().primaryKey().generatedAlwaysAsIdentity({ name: "23719894", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647 }),
